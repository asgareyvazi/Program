...
TEMPLATE_REFERENCES: Dict[str, List[Tuple[str, str]]] = {
    "drilling_program": [
        ...
        ("723", "Drilling Engineering"),
        ("727", "Drilling Program (WDI)"),
        ("740", "Standard Operating Procedures for Drilling Operations"),
        ("720", "Drilling Data Handbook"),
        ("717", "Drilling and Completion Engineering"),
        ("718", "Drilling Cost Control"),
        ("719", "Drilling Cost Estimation"),
        ("721", "Drilling Economics"),
        ("749", "Well Drilling Costs Analysis"),
        ("728", "Drilling Calculations (Maersk)"),
        ("722", "Drilling Engineering Drilling Fluids"),
],
    "advanced_drilling_program": [
        ...
        ("720", "Drilling Data Handbook"),
        ("717", "Drilling and Completion Engineering"),
        ("715", "Directional Drilling"),
        ("729", "Extended Reach Drilling Guidelines (BP)"),
        ("746", "Torque and Drag in Drilling"),
        ("732", "Hole Opening Guidelines"),
],
    "workover_program": [
        ...
        ("701", "Practical Well Planning and Drilling Manual"),
        ("713", "Completions and Workovers"),
        ("750", "Workover and Testing"),
        ("707", "Completion Design Manual (BP)"),
],
    ...
    "offshore_drilling_program": [
        ...
        ("698", "Drilling Manual (12th Edition)"),
        ("690", "Drilling Manual — Volume 1"),
        ("734", "Offshore Drilling Operations Manual"),
        ("729", "Extended Reach Drilling Guidelines (BP)"),
        ("728", "Drilling Calculations (Maersk)"),
],
    "cementing_program": [
        ...
        ("705", "Baker Handbook (cementing section)"),
        ("725", "Drilling Practices — Casing/Wellbore deviation (SLB)"),
],
    "well_kill_program": [
        ...
        ("698", "Drilling Manual (12th Edition)"),
        ("739", "SLB Drilling Operating Practices"),
],
    "fishing_program": [
    ...
    "stuck_pipe_procedure": [
        ...
        ("708", "Stuck Pipe Manual (BP)"),
        ("714", "Comprehensive Stuck Pipe"),
        ("716", "Driller Stuck Pipe Handbook"),
        ("741", "Stuck Pipe (Total)"),
        ("742", "Stuck Pipe"),
        ("743", "Stuck Pipe 1"),
        ("744", "Stuck Pipe Poster"),
        ("745", "Stuck Pipe Prevention Rev1"),
        ("751", "Stuck Pipe Types (Persian)"),
],
    "slickline_procedure": [
    ...
    "rig_move_procedure": [
        ...
        ("724", "Drilling Operations Guidelines"),
],
    "h2s_emergency_procedure": [
        ...
        ("698", "Drilling Manual (12th Edition)"),
        ("736", "Safety in Drilling Manual (Shell)"),
],
    ...
    "bha_makeup_procedure": [
        ...
        ("698", "Drilling Manual (12th Edition)"),
        ("735", "Drilling Bit Running Guidelines (SLB)"),
        ("726", "Drilling Practices (SLB)"),
],
    "casing_running_cementing_procedure": [
        ...
        ("690", "Drilling Manual — Casing & Cementing chapter"),
        ("698", "Drilling Manual (12th Edition)"),
        ("703", "Casing Design (Applied Drilling Engineering)"),
        ("704", "Casing Design"),
        ("709", "Casing Design"),
        ("710", "Casing Design Manual (Statoil)"),
],
