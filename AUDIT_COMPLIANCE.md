...
| Testing | 3.5 | ✅ **۱۲۹۴+ تست در ۱۰ سویت + ۲۴۰ آیتم Audit** | `tests/run_all.py` (235 مرجع + 67 حاکمیتی + 51 قالب + 25 UI + 51 API + 72 کیفیت + 721 خروجی + 49 یکپارچگی + **18 Registry Audit**) |
