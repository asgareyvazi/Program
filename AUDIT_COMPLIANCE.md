...
| Testing | 3.5 | ✅ **۱۳۱۳+ تست در ۱۰ سویت + ۲۴۰ آیتم Audit** | `tests/run_all.py` (249 مرجع + 67 حاکمیتی + 51 قالب + 28 UI + 54 API + 72 کیفیت + 721 خروجی + 49 یکپارچگی + **18 Registry Audit**) |
