...
| Testing | 3.5 | ✅ **۱۳۲۲+ تست در ۱۰ سویت + ۲۴۰ آیتم Audit** | `tests/run_all.py` (255 مرجع + 74 حاکمیتی + 51 قالب + 28 UI + 54 API + 72 کیفیت + 721 خروجی + 49 یکپارچگی + **18 Registry Audit**) |
