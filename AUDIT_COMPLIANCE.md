...
| Testing | 3.5 | ✅ **۱۳۰۱+ تست در ۱۰ سویت + ۲۴۰ آیتم Audit** | `tests/run_all.py` (242 مرجع + 67 حاکمیتی + 51 قالب + 28 UI + 53 API + 72 کیفیت + 721 خروجی + 49 یکپارچگی + **18 Registry Audit**) |
