...
TEMPLATE_REFERENCES: Dict[str, List[Tuple[str, str]]] = {
    "drilling_program": [
        ...
        ("773", "Drilling Engineering"),
        ("777", "Drilling Program (WDI)"),
        ("790", "Standard Operating Procedures for Drilling Operations"),
        ("770", "Drilling Data Handbook"),
        ("767", "Drilling and Completion Engineering"),
        ("768", "Drilling Cost Control"),
        ("769", "Drilling Cost Estimation"),
        ("771", "Drilling Economics"),
        ("799", "Well Drilling Costs Analysis"),
        ("778", "Drilling Calculations (Maersk)"),
        ("772", "Drilling Engineering Drilling Fluids"),
],
    "advanced_drilling_program": [
        ...
        ("770", "Drilling Data Handbook"),
        ("767", "Drilling and Completion Engineering"),
        ("765", "Directional Drilling"),
        ("779", "Extended Reach Drilling Guidelines (BP)"),
        ("796", "Torque and Drag in Drilling"),
        ("782", "Hole Opening Guidelines"),
],
    "workover_program": [
        ...
        ("701", "Practical Well Planning and Drilling Manual"),
        ("763", "Completions and Workovers"),
        ("800", "Workover and Testing"),
        ("757", "Completion Design Manual (BP)"),
],
    ...
    "offshore_drilling_program": [
        ...
        ("698", "Drilling Manual (12th Edition)"),
        ("690", "Drilling Manual — Volume 1"),
        ("784", "Offshore Drilling Operations Manual"),
        ("779", "Extended Reach Drilling Guidelines (BP)"),
        ("778", "Drilling Calculations (Maersk)"),
],
    "cementing_program": [
        ...
        ("755", "Baker Handbook (cementing section)"),
        ("775", "Drilling Practices — Casing/Wellbore deviation (SLB)"),
],
    "well_kill_program": [
        ...
        ("698", "Drilling Manual (12th Edition)"),
        ("789", "SLB Drilling Operating Practices"),
],
    "fishing_program": [
    ...
    "stuck_pipe_procedure": [
        ...
        ("758", "Stuck Pipe Manual (BP)"),
        ("764", "Comprehensive Stuck Pipe"),
        ("766", "Driller Stuck Pipe Handbook"),
        ("791", "Stuck Pipe (Total)"),
        ("792", "Stuck Pipe"),
        ("793", "Stuck Pipe 1"),
        ("794", "Stuck Pipe Poster"),
        ("795", "Stuck Pipe Prevention Rev1"),
        ("801", "Stuck Pipe Types (Persian)"),
],
    "slickline_procedure": [
    ...
    "rig_move_procedure": [
        ...
        ("774", "Drilling Operations Guidelines"),
],
    "h2s_emergency_procedure": [
        ...
        ("698", "Drilling Manual (12th Edition)"),
        ("786", "Safety in Drilling Manual (Shell)"),
],
    ...
    "bha_makeup_procedure": [
        ...
        ("698", "Drilling Manual (12th Edition)"),
        ("785", "Drilling Bit Running Guidelines (SLB)"),
        ("776", "Drilling Practices (SLB)"),
],
    "casing_running_cementing_procedure": [
        ...
        ("690", "Drilling Manual — Casing & Cementing chapter"),
        ("698", "Drilling Manual (12th Edition)"),
        ("753", "Casing Design (Applied Drilling Engineering)"),
        ("754", "Casing Design"),
        ("759", "Casing Design"),
        ("760", "Casing Design Manual (Statoil)"),
],
